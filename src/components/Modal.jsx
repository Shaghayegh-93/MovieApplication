...
const Modal = ({ isOpen, setIsOpen, children }) => {
  ...
  return (
    <div className="z-10 relative w-full ">
      ...
      ></div>
      <div className="h-full w-44 md:w-[500px]  min-h-[250px] absolute top-0 left-52 md:-left-96 -translate-x-full -translate-y-44 md:translate-y-1/2 bg-slate-800 p-4 rounded-2xl shadow-modalShadow">
